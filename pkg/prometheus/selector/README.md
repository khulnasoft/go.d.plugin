...
custom_edit_url: "https://github.com/khulnasoft/go.d.plugin/edit/master/pkg/prometheus/selector/README.md"
...
The metric name pattern syntax is [simple pattern](https://github.com/khulnasoft/khulnasoft/blob/master/src/libkhulnasoft/simple_pattern/README.md).
...
-   `=*`: Match labels that [simple-pattern-match](https://github.com/khulnasoft/khulnasoft/blob/master/src/libkhulnasoft/simple_pattern/README.md) the provided string.
-   `!*`: Match labels that do not [simple-pattern-match](https://github.com/khulnasoft/khulnasoft/blob/master/src/libkhulnasoft/simple_pattern/README.md) the provided string.
