<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.d.plugin/edit/master/modules/portcheck/README.md"
meta_yaml: "https://github.com/khulnasoft/go.d.plugin/edit/master/modules/portcheck/metadata.yaml"
...
|:------------|:----------|:------------|
| [ portcheck_service_reachable ](https://github.com/khulnasoft/khulnasoft/blob/master/src/health/health.d/portcheck.conf) | portcheck.status | TCP host ${label:host} port ${label:port} liveness status |
| [ portcheck_connection_timeouts ](https://github.com/khulnasoft/khulnasoft/blob/master/src/health/health.d/portcheck.conf) | portcheck.status | percentage of timed-out TCP connections to host ${label:host} port ${label:port} in the last 5 minutes |
| [ portcheck_connection_fails ](https://github.com/khulnasoft/khulnasoft/blob/master/src/health/health.d/portcheck.conf) | portcheck.status | percentage of failed TCP connections to host ${label:host} port ${label:port} in the last 5 minutes |
